...
It is a Laravel **UI / backend-for-frontend (BFF)** over the **007 Resort & Spa API** (ASP.NET Core),
...
- Composer 2
- Node.js 24 + npm
- A reachable 007 Resort & Spa API instance (cloud-mode API in production)
...
- `GET /health` - `{"status":"ok","service":"007resort-booking-web"}`
